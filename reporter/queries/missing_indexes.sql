...
LEFT JOIN instance_indexes i2 ON a.OWNER = i2.OWNER AND a.TABLE_NAME = i2.TABLE_NAME AND a.INDEX_NAME = i1.INDEX_NAME  AND i2.instance_id = '<instance_2_id>'
WHERE (i1.INDEX_NAME IS NULL OR i2.INDEX_NAME IS NULL) AND INDEX_TYPE != 'LOB'
